...
// Strict existence check: returns true if any admin user exists. Unlike
// countAdminUsers(), this lets DB errors propagate so callers can distinguish
// "no users" from "database unreachable".
