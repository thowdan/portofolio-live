...
export const DEFAULT_CONTENT = {
  site: {
    // TODO: set this to your real domain once you have one (e.g. https://thowdan.dev).
    // Until then the default Vercel subdomain works for everything but absolute SEO URLs.
